...
- Parent
  ...
  - Trace: [001-1-4-1-3-5-1-2-1-1-1-anchor-to-kodax-vs-code-core-boundary-recovery-and-extension-hos.trace.md](001-1-4-1-3-5-1-2-1-1-1-anchor-to-kodax-vs-code-core-boundary-recovery-and-extension-hos.trace.md)
  - Origin:
    - [relative](001-1-4-1-3-5-1-2-1-1-1-anchor-to-kodax-vs-code-core-boundary-recovery-and-extension-hos.trace.md)
- Current
  - Current Schema: [tiinex.handoff.v1](https://github.com/Tiinex/docs/blob/3988951208eb9a8926e84ab42625d4b42fa00c2d/.topics/.schemas/coordination/handoff/tiinex.handoff.v1.schema.md)
  - Created At: 2026-09-21 15:36:36
  - Authors: Anchor
  - Why: Manufacture correctly failed closed because the immediately prior Handoff referenced a non-existent prior Kodax audit Evidence path; preserve that historical artifact and issue a qualified corrective continuation.
  - Summary: Correct the prior Kodax audit Evidence reference without changing delegated scope, authority, or acceptance boundary.
  - Status: ready/local

---

# Anchor To Kodax — VS Code Core-Boundary Recovery And Extension Host Acceptance — Corrected Context

## Handoff Parties

- Purpose: supersede the immediately prior Kodax delegation only to correct its unresolved prior-audit Material Reference, while preserving the same final implementation-ready architecture-recovery host tranche against the exact Anchor-accepted Core frontier; Sigma remains deliberately excluded until machine acceptance is complete.
- From: Anchor
- From Kind: role
...
- prior-kodax-audit
  ...
  - Material Reference: [Kodax Host Audit](business::.topics/processes/gpt/grounding/001-1-4-1-3-3-1-kodax-vs-code-host-boundary-audit-evidence.trace.md)
...
- [sha256-base64url-c14n-v2](https://github.com/Tiinex/docs/blob/3988951208eb9a8926e84ab42625d4b42fa00c2d/.topics/.validators/sha256-base64url-c14n-v2.validator.md)
  - Towards: [001-1-4-1-3-5-1-2-1-1-1-anchor-to-kodax-vs-code-core-boundary-recovery-and-extension-hos.trace.md](001-1-4-1-3-5-1-2-1-1-1-anchor-to-kodax-vs-code-core-boundary-recovery-and-extension-hos.trace.md)
