...
- Current
  ...
  - Created At: 2026-09-11 15:32:06
  - Authors: Anchor
  - Why: The first Loom carrier exposed a route-leaf manufacture blind spot: a selected Handoff that has a declared child cannot be grounded as the continuation leaf.
  - Summary: Re-delegate the bounded lineage-safety repair from the current recovery leaf after the prior Loom carrier correctly failed cold grounding.
  - Status: ready/local

---

# Anchor to Loom — Carrier Major 002 lineage-safety hardening retry

## Handoff Parties

- Retry Context: The previously manufactured `business-002-2` Loom route correctly failed cold grounding because this Handoff had gained a declared child before manufacture and was therefore no longer the selected Parent-lineage leaf. This retry re-delegates the same bounded work from the current recovery leaf without rewriting history.
