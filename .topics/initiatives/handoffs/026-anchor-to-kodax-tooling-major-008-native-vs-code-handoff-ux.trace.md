...
- Current
  ...
  - Authors: Anchor
  - Why: Give Kodax the exact current host seams and strict no-duplication boundary before implementation.
  - Summary: Implement the thin VS Code half of Major 008 from exact Anchor gap evidence: open-root endpoint selectors, Attach participant multi-select, durable edit/reload UX, and truthful Core-backed preview.
  - Status: ready/local
