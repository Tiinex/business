...
- Current
  ...
  - Created At: 2026-09-22 15:23:10
  - Authors: Anchor
  - Why: Give Loom the exact current seams and strict non-regression boundaries before implementation so Package V1 is extended rather than redesigned.
  - Summary: Implement the Core half of Major 008 from exact Anchor gap evidence: durable endpoint References, explicit participant material closure, truthful Package V1 projection, and numeric pointer lineage.
  - Status: ready/local
...
- anchor-initial-gap-discovery
  - Material: exact Anchor source/contract discovery isolating the current durable endpoint authoring, explicit participant-selection, Package V1 reuse and truthful-preview seams.
  ...
  - Purpose: begin implementation from proven current seams rather than reopening package representation discovery.
