...
- Current
  ...
  - Authors: Anchor
  - Why: Keep this current organizational branch readable from the Tiinex organization root without relying on directory names or conversation history.
  - Summary: Initiatives
...
Use concrete Project artifacts when an initiative actually exists. Do not pre-create corporate-style categories or projects without material that demonstrates a real subject boundary.
